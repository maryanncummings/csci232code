...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    // value associated with the given key in subtree rooted at x; null if n    o such key
    private String getColor(Node x, Key key) {
        while (x != null) {
            int cmp = key.compareTo(x.key);
            if      (cmp < 0) x = x.left;
            else if (cmp > 0) x = x.right;
            else return (x.color == RED ? "Red" : "Black");
        }
        return null;
    }
    ...
    ***************************************************************************/
    ...
    public void put(Key key, Value val) {
        ...
        root.color = BLACK;
        // System.out.println("in put, key is " + key + ", root is " + root.key);
        //keys();
    ...
    private Node put(Node h, Key key, Value val) { 
        if (h == null) {
            System.out.println("in put, val is " + val);
        ...
        if      (cmp < 0) h.left  = put(h.left,  key, val); 
              ...
              System.out.println("in else val is " + val);
              h.val   = val;
        }
    ...
    ***************************************************************************/
    ...
    public Iterable<Key> keys(Key lo, Key hi) {
        ...
        // System.out.println("root is " + root.key + ", color: " +
        //        (isRed(root)? "red" : "black"));
    ...
    private void keys(Node x, Queue<Key> queue, Key lo, Key hi) { 
        ...
        if (cmplo <= 0 && cmphi >= 0) {
            queue.enqueue(x.key);
            // System.out.println("key: " + x.key + ", color: " + 
            //        (isRed(x)? "red" : "black"));
        } 
